...
| `🏮 香江灯影` | 香港与澳门节点测速池 | `香港`、`澳门/澳門`、`Hong Kong`、`Macau/Macao`、`MO-01` 等带编号节点名 | `url-test` 自动择优；澳门节点并入此组 |
| `🪭 宝岛团扇` | 台湾节点测速池 | 台湾、台北、Taiwan、Taipei、TWN 等命名 | `url-test` 自动择优 |
